      ...
      <div class="split">
              ...
              >
                ...
                <div class="icons">
                  ...
                  <div
                    ...
                    :class="{
                      active:
                        param.ref in filters &&
                        filters[param.ref].includes(0.5),
                    }"
                  ></div>
                  <div
        ...
        <div class="group" v-if="open">
          <label>
            ...
            <button
              @click="
                filters.models = props.originalModels.map((x) => x.filename)
              "
            >
              Select all
            </button>
          ...
          <div class="models">
            <div
              class="model"
              v-for="model in props.originalModels"
              @click="toggleModel(model.filename)"
              :class="{
                active:
                  'models' in filters &&
                  filters.models.includes(model.filename),
              }"
            >
...
.param .circle-icon:hover {
  opacity: 0.5;
}
.param .circle-icon.active {
  opacity: 1;
}
.param .circle-icon.closed-icon {
  color: var(--g1);
}
.param .circle-icon.partial-icon {
  color: var(--g2);
}
.param .circle-icon.open-icon {
  color: var(--g3);
}
